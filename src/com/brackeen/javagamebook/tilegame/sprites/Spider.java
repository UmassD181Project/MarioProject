...
public class Spider extends Creature {
	...
	// have elapsed.
	private long initJumpInterval = 1/*2 * MILI_PER_SECOND*/; 
...
//    private Throwable e = new Throwable();
	 ...
	 * @param deadRight
	 */
	public Spider(Animation left, Animation right, Animation deadLeft, Animation deadRight) {
	...
	//TODO Set how fast you want the spider to move.
